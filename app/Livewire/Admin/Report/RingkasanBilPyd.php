...
class RingkasanBilPyd extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        return view('livewire.admin.report.ringkasan-bil-pyd', compact('results', 'stateSelection', 'branchSelection', 'pmgiLevel'))->extends('layouts.main');
    }
}
