...
class RingkasanPrestasiPYD extends Component
{
    use WithPagination;
    ...
    public function mount()
    {
        ...
        $this->report_date = $anchorDate->copy()->subMonthNoOverflow()->endOfMonth()->toDateString();
        $this->negeri = 'ALL';
    ...
    public function render()
    {
        ...
        $percentage = RefEvalPctg::where('state_code', '01') // once da approve utk by negeri, tukar ni.. skrg pkai 01 sbb smua negeri sama value
                ->whereDate('effective_date', '<=', $this->report_date)
                ->orderBy('evaluation_id', 'ASC')
                ->get();

        return view('livewire.admin.report.ringkasan-prestasi-pyd', compact('results', 'stateSelection', 'branchSelection', 'pmgiLevel', 'percentage'))->extends('layouts.main');
    }
}
