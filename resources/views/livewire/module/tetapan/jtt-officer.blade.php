        ...
        <div class="p-4 my-4 bg-white rounded-lg border border-gray-200 shadow-sm sm:p-6">
            ...
            <div class="items-center">
                <div class="mb-4 lg:mb-0">
                    <h3 class="mb-2 text-xl font-bold text-gray-900">Tetapan Ahli JKPI</h3>
                    <span class="text-base font-normal text-gray-500">Tetapan ahli mesyuarat JKPI</span>
                    <div class="mt-6">
                        <div>
                            <div class="p-4 my-4 bg-white rounded-lg border border-gray-200 shadow-sm sm:p-6">
                                <div class="flex justify-between">
                                    <div class="grid w-[50%] grid-cols-1 gap-x-4 gap-y-2">
                                        <div>
                                            ...
                                            <input type="text" id="nama-pegawai" class="block p-2 w-full text-xs text-gray-900 uppercase bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500" wire:model="name" wire:keydown.enter="find">
                                        </div>
                                    </div>
                    ...
                    {{-- current jtt --}}
                    <div class="mt-6">
                        <h3 class="mb-2 text-xl font-bold text-gray-900">Senarai Ahli JKPI</h3>
                        <div>
