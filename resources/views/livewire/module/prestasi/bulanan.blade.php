                ...
                <div class="mb-4 lg:mb-0">
                    ...
                    <div class="p-6 mt-4 rounded-lg border shadow bg-primary-100 border-primary-200 dark:bg-gray-800 dark:border-gray-700">
                        <div class="flex justify-between">
                            ...
                            <div class="flex">
                                @if($result)
                                    <div class="inline-flex items-center px-3 py-2 mt-4 mr-4 text-sm font-medium text-center text-white bg-lime-500 rounded-lg cursor-pointer hover:bg-lime-800 focus:ring-4 focus:outline-none focus:ring-lime-300 dark:bg-lime-600 dark:hover:bg-lime-700 dark:focus:ring-lime-800" wire:click="download">
