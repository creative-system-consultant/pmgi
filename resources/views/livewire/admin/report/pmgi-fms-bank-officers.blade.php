      ...
      <tbody class="text-sm text-gray-700 dark:text-gray-200">
        @forelse ($data as $item)
          <tr class="text-xs hover:bg-gray-50 dark:hover:bg-gray-800/70">
            ...
            <td class="py-2 px-4 text-left border border-gray-300 dark:border-gray-700">{{ $item->nokp }}</td>
            <td class="py-2 px-4 text-left border border-gray-300 dark:border-gray-700">{{ $item->branch_code }}</td> 
            <td class="py-2 px-4 text-left border border-gray-300 dark:border-gray-700">{{ $item->staffno }}</td> 
            <td class="py-2 px-4 text-left border border-gray-300 dark:border-gray-700">{{ $item->fms_userstatus == '1' ? 'Aktif' : 'Tidak Aktif' }}</td> 
            <td class="py-2 px-4 text-left border border-gray-300 dark:border-gray-700">{{ $item->officer_position }}</td>            
            <td class="py-2 px-4 text-left border border-gray-300 dark:border-gray-700">{{ $item->hr_mgr_flag == 'Y' ? 'Ya' : 'Tidak' }}</td>            
            <td class="py-2 px-4 text-left border border-gray-300 dark:border-gray-700">{{ $item->hr_date_resign }}</td>            
          </tr>
        @empty
          <tr>
