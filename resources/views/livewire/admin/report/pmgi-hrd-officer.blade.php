      ...
      <tbody class="text-sm text-gray-700 dark:text-gray-200">
        @forelse ($data as $item)
          <tr class="text-xs hover:bg-gray-50 dark:hover:bg-gray-800/70">
            ...
            <td class="py-2 px-4 w-px lg:w-auto text-left border border-gray-300 dark:border-gray-700">{{ $item->no_pekerja }}</td>
            <td class="py-2 px-4 w-auto text-left border border-gray-300 dark:border-gray-700">{{ $item->nama }}</td> 
            <td class="py-2 px-4 w-px text-left border border-gray-300 dark:border-gray-700">{{ $item->no_kp }}</td> 
            <td class="py-2 px-4 text-left border border-gray-300 dark:border-gray-700">{{ $item->jawatan }}</td> 
            <td class="py-2 px-4 text-left border border-gray-300 dark:border-gray-700">{{ $item->status }}</td>            
            <td class="py-2 px-4 text-left border border-gray-300 dark:border-gray-700">{{ $item->resign_date ?  date('d/m/Y', strtotime($item->resign_date)) : ''}}</td>            
            <td class="py-2 px-4 text-left border border-gray-300 dark:border-gray-700">{{ $item->tarikh_cuti_hingga ? date('d/m/Y', strtotime($item->tarikh_cuti_hingga)) : '' }}</td>            
            <td class="py-2 px-4 text-left border border-gray-300 dark:border-gray-700">{{ $item->tarikh_cuti_dari ? date('d/m/Y', strtotime($item->tarikh_cuti_dari)) : ''}}</td>            
            <td class="py-2 px-4 text-left border border-gray-300 dark:border-gray-700">{{ $item->kod_cuti }}</td>            
          </tr>
        @empty
          <tr>
