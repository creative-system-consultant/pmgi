    ...
    <table class="w-full border border-gray-200 dark:border-gray-700 rounded-lg text-sm">
      ...
      <thead>
        <tr class="bg-gray-300 dark:bg-gray-800 text-sm text-gray-600 dark:text-gray-300">
          ...
          <th class="py-2 px-4 text-left border border-gray-400 dark:border-gray-700">Nama Peranan</th>
          <th class="py-2 px-4 text-left border border-gray-400 dark:border-gray-700">Deskripsi Peranan</th>
      ...
      <tbody class="text-sm text-gray-700 dark:text-gray-200">
        @forelse ($data as $item)
          <tr class="bg-gray-200 hover:bg-gray-100 dark:bg-gray-600 dark:hover:bg-gray-800/70">
            ...
            <td class="py-2 px-4 border border-gray-400 dark:border-gray-700">{{ $item->role_name }}</td>
            <td class="py-2 px-4 bg-white hover:bg-gray-100 border border-gray-400 dark:bg-gray-500 dark:border-gray-700">{{ $item->role_description }}</td>
