    ...
    <table class="w-full border border-gray-200 dark:border-gray-700 rounded-lg text-sm">
      ...
      <thead>
        <tr class="bg-gray-100 dark:bg-gray-800 text-sm text-gray-600 dark:text-gray-300">
            ...
            <th class="py-2 px-4 text-left border border-gray-300 dark:border-gray-700">Negeri Dalam HR</th>
            <th class="py-2 px-4 text-left border border-gray-300 dark:border-gray-700">Cawangan Dalam HR</th>
        </tr>
      </thead>
      ...
      <tbody class="text-sm text-gray-700 dark:text-gray-200">
        @forelse ($data as $item)
          <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/70">
            ...
            <td class="py-2 px-4 text-left border border-gray-300 dark:border-gray-700">{{ $item->hr_state_name }}</td>
            <td class="py-2 px-4 text-left border border-gray-300 dark:border-gray-700">{{ $item->hr_branch_name }}</td>
          </tr>
