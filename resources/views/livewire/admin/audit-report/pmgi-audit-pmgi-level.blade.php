        ...
        <tbody class="text-sm text-gray-700 dark:text-gray-200">
          @forelse ($data as $item)
            <tr class="text-xs hover:bg-gray-50 dark:hover:bg-gray-800/70">
              ...
              <td class="py-2 px-4 text-left text-sm border border-gray-300 dark:border-gray-700">{{ $item->seq_no }}</td>
              <td class="py-2 px-4 text-left text-sm border border-gray-300 dark:border-gray-700">{{ $item->pmgi_level }}</td>
              <td class="py-2 px-4 text-left text-sm border border-gray-300 dark:border-gray-700">{{ $item->pmgi_level_desc }}</td>
              <td class="py-2 px-4 text-left text-sm border border-gray-300 dark:border-gray-700">{{ $item->pmgi_sys_level_desc }}</td>
              <td class="py-2 px-4 text-left text-sm border border-gray-300 dark:border-gray-700">
