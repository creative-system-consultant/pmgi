<div class="ml-4">
  <h2 class="mt-6 text-2xl font-semibold text-gray-800 mb-4 border-b border-gray-300 pb-2 dark:text-gray-100">
    Laporan Audit Pemetaan Negeri - HR ke FMS
  </h2>
      ...
      <table class="w-full border border-gray-200 dark:border-gray-700 rounded-lg text-sm">
        ...
        <tbody class="text-sm text-gray-700 dark:text-gray-200">
          @forelse ($data as $item)
            ...
            <td class="py-2 px-4 text-left text-sm border border-gray-300 dark:border-gray-700">{{ $item->hr_state_name}}</td>             
              <td class="py-2 px-4 text-left text-sm border border-gray-300 dark:border-gray-700">{{ $item->fms_state_code}} </td>
              <td class="py-2 px-4 text-left text-sm border border-gray-300 dark:border-gray-700">{{ $item->fms_state_name }}</td>
              <td class="py-2 px-4 text-left text-sm border border-gray-300 dark:border-gray-700">
