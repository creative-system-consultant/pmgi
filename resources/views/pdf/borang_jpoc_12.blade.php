...
<body>
    <!--------------------------------------------------------------- page 1 ----------------------------------------------------------------------------->
    <div class="centered">
        <img src="image/borang/pmgi12/BorangJpocPmgi12-1.jpg" alt="BORANG JPoc PMGi 12" style="margin-top: 200px" width="700" height="900">
    ...
    <!--------------------------------------------------------------- page 2 ----------------------------------------------------------------------------->
    <div class="centered">
        <img src="image/borang/pmgi12/BorangJpocPmgi12-2.jpg" alt="BORANG JPoc PMGi 12" style="margin-top: 200px" width="700" height="900">
        <div class="content-overlay">
    ...
    <!--------------------------------------------------------------- page 3 ----------------------------------------------------------------------------->
    <div class="centered">
        <img src="image/borang/pmgi12/BorangJpocPmgi12-3.jpg" alt="BORANG JPoc PMGi 12" style="margin-top: 200px" width="700" height="900">
        <div class="content-overlay">
            {{-- masalah dihadapi --}}
    ...
    <!--------------------------------------------------------------- page 4 ----------------------------------------------------------------------------->
    <div class="centered">
        <img src="image/borang/pmgi12/BorangJpocPmgi12-4.jpg" alt="BORANG JPoc PMGi 12" style="margin-top: 200px" width="700" height="900">
        <div class="content-overlay">
            {{-- ulasan --}}
    ...
    <!--------------------------------------------------------------- page 5 ----------------------------------------------------------------------------->
    <div class="centered">
        <img src="image/borang/pmgi12/BorangJpocPmgi12-5.jpg" alt="BORANG JPoc PMGi 12" style="margin-top: 200px" width="700" height="900">
        <div class="content-overlay">
            {{-- nama --}}
    ...
    <!--------------------------------------------------------------- page 6 ----------------------------------------------------------------------------->
    <div class="centered">
        <img src="image/borang/pmgi12/BorangJpocPmgi12-6.jpg" alt="BORANG JPoc PMGi 12" style="margin-top: 200px" width="700" height="900">
        <div class="content-overlay">
            <div class="input-container">
    ...
    <!--------------------------------------------------------------- page 6 ----------------------------------------------------------------------------->
    <div class="centered">
        <img src="image/borang/pmgi12/BorangJpocPmgi12-7.jpg" alt="BORANG JPoc PMGi 12" style="margin-top: 200px" width="700" height="900">
        <div class="content-overlay">
            <div class="input-container">
