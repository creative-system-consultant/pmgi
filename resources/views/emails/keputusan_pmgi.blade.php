...
<head>
    ...
    <style>
        @media (max-width: 620px) {
            ...
            .pc-w620-fontSize-26px {
                font-size: 26px !important;
            }

            .pc-w620-padding-30-0-24-0 {
            ...
            .pc-w620-padding-10-0-10-0 {
                padding: 10px 0px 10px 0px !important;
            }

            table.pc-w620-spacing-5-10-5-10 {
                margin: 5px 10px 5px 10px !important;
            }

            td.pc-w620-spacing-5-10-5-10,
            th.pc-w620-spacing-5-10-5-10 {
                margin: 0 !important;
                padding: 5px 10px 5px 10px !important;
            }

            table.pc-w620-spacing-10-20-20-20 {
                margin: 10px 20px 20px 20px !important;
            }

            td.pc-w620-spacing-10-20-20-20,
            th.pc-w620-spacing-10-20-20-20 {
                margin: 0 !important;
                padding: 10px 20px 20px 20px !important;
            }

            .pc-w620-padding-20-28-0-28 {
...
<body class="body pc-font-alt" style="width: 100% !important; min-height: 100% !important; margin: 0 !important; padding: 0 !important; line-height: 1.5; color: #2D3A41; mso-line-height-rule: exactly; -webkit-font-smoothing: antialiased; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; font-variant-ligatures: normal; text-rendering: optimizeLegibility; -moz-osx-font-smoothing: grayscale; background-color: #5ba183;" bgcolor="#5ba183">
    <table class="pc-project-body" style="table-layout: fixed; min-width: 600px; background-color: #5ba183;" bgcolor="#5ba183" width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
        <tr>
                    ...
                    <tr>
                        <td class="pc-w620-padding-0-0-0-0" style="padding: 20px 0px 0px 0px;" align="left" valign="top">
                            <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width: 100%;">
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                            <tr>
                                                <td class="pc-w620-spacing-0-0-0-0" style="padding: 0px 0px 0px 0px;">
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                                        <tr>
                                                            <td valign="top" class="pc-w620-padding-30-0-24-0" style="padding: 40px 40px 20px 40px; border-radius: 20px 20px 0px 0px; background-color: #e8faf3;" bgcolor="#e8faf3">
                                                                <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                                    <tr>
                                                                        <td align="center" valign="top" style="padding: 0px 0px 24px 0px;">
                                                                            <img src="D:\Development\laravel\PMGI\public\image/logo-tekun.png" class="" width="100" height="100" alt="" style="display: block; outline: 0; line-height: 100%; -ms-interpolation-mode: bicubic; width:100px; height: auto; max-width: 100%; border-radius: 58px 58px 58px 58px; border: 0;" />
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                                            ...
                                                                            <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" align="center" style="border-collapse: separate; border-spacing: 0; margin-right: auto; margin-left: auto;">
                                                                                <tr>
                                                                                    <td valign="top" align="center" style="padding: 0px 10px 0px 10px;">
                                                                                        <div class="pc-font-alt pc-w620-fontSize-26px" style="line-height: 100%; letter-spacing: -0.04em; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: bold; font-variant-ligatures: normal; color: #26392a; text-align: left; text-align-last: left;">
                                                                                            <div>
                                                                                                <span>Per: Peringatan - Prestasi Kerja Tidak Mencapai Sasaran Ditetapkan </span>
                                                                                            </div>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
                                ...
                                <tr>
                                    <td valign="top">
                                        <!-- BEGIN MODULE: Email body -->
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                            <tr>
                                                <td class="pc-w620-spacing-0-0-0-0" style="padding: 0px 0px 0px 0px;">
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                                        <tr>
                                                            <td valign="top" class="pc-w620-padding-28-24-28-24" style="padding: 40px 40px 20px 40px; border-radius: 0px; background-color: #ffffff;" bgcolor="#ffffff">
                                                                <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                                    <tr>
                                                                            ...
                                                                            <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" align="left" style="border-collapse: separate; border-spacing: 0; margin-right: auto; margin-left: auto;">
                                                                                <tr>
                                                                                    <td valign="top" align="left">
                                                                                        <div class="pc-font-alt pc-w620-fontSize-14px" style="line-height: 21px; letter-spacing: -0.2px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: normal; font-variant-ligatures: normal; color: #333333; text-align: left; text-align-last: left;">
                                                                                            <div><span>Tuan / Puan, {{ $pyd_name }} {{ $pyd_ic }}</span>
                                                                                            </div>
                                                                                            <div><span><br />Dengan segala hormatnya perkara di atas dirujuk.</span>
                                                                                            </div>
                                                                                            <div><span><br />2. &nbsp; &nbsp; &nbsp; Berdasarkan kepada penilaian yang telah dibuat oleh JPOC mendapati prestasi kerja tuan/puan tidak mencapai prestasi sepertimana yang telah ditetapkan iaitu dengan merujuk kepada sesi penilaian {{ $pmgi_type }} {{ $pmgi_level }} yang telah diadakan pada {{ $pmgi_session_date }}</span>
                                                                                            </div>
                                                                                            <div><span><br />3. &nbsp; &nbsp; &nbsp; Sehubungan itu, tuan/puan dipohon untuk memastikan segala pelan tindakan yang telah dinyatakan pada sesi  {{ $pmgi_type }} {{ $pmgi_level }} yang lepas untuk dilaksanakan sepenuhnya oleh tuan/puan. Kami ingin menegaskan kegagalan tuan/puan untuk meningkatkan prestasi dalam tempoh masa yang telah ditetapkan boleh menyebabkan tindakan tatatertib diambil termasuk kemungkinan penamatan perkhidmatan.</span>
                                                                                            </div>
                                                                                            <div><span><br />Kerjasama dan perhatian tuan/puan dalam perkara ini amat dihargai.</span>
                                                                                            </div>
                                                                                            <div><span><br />Sekian, terima kasih.</span>
                                                                                            </div>
                                                                                            <div><span><br />Yang benar,</span>
                                                                                            </div>
                                                                                            {{-- <div><span><br />in_array($pmgi_level, ['PM1', 'PM2']) ? {{ pym_name }} : ($pmgi_level == 'PM3' ? {{ $pmc_name }} : {{ $jpoc_name }})</span> --}}
                                                                                            </div>
                                                                                            <div><span> </span>
                                                                                            </div>
                                                                                        </div>
                                                                    ...
                                                                    <tr>
                                                                        <td valign="top" style="padding: 24px 0px 24px 0px;">
                                                                            <table class="pc-w620-width-100pc" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                                                <tr>
                                                                                    <td height="1" valign="top" style="line-height: 1px; font-size: 1px; border-bottom: 2px solid #e8e8e8;">&nbsp;</td>
                                                                                </tr>
                                                                            </table>
                                                                        </td>
                                                                    </tr>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                            <tr>
                                                <td class="pc-w620-spacing-0-0-0-0" style="padding: 0px 0px 0px 0px;">
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                                        <tr>
                                                            <td valign="top" class="pc-w620-padding-20-28-0-28" style="padding: 30px 28px 30px 28px; border-radius: 0px 0px 20px 20px; background-color: #0b251b;" bgcolor="#0b251b">
                                                                <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                                    <tr>
                                                                        <td class="pc-w620-spacing-0-0-20-0" style="padding: 0px 0px 0px 0px;">
                                                                                ...
                                                                                <tr class="pc-grid-tr-first pc-grid-tr-last">
                                                                                    <td class="pc-grid-td-first pc-grid-td-last pc-w620-itemsSpacings-0-40" align="left" valign="top" style="width: 50%; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px;">
                                                                                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse: separate; border-spacing: 0;">
                                                                                            <tr>
                                                                                                <td class="pc-w620-padding-0-0-0-0" align="center" valign="middle" style="background-color: #e8faf3; border-radius: 16px 16px 16px 16px; border: 1px solid transparent;">
                                                                                            ...
                                                                                            <div><span style="font-family: Arial, Helvetica, sans-serif;font-weight: 700;font-style: normal;">Hadapi Masalah?</span>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td align="center" valign="top">
                                                                                                                <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width: 100%;">
                                                                                                                    <tr>
                                                                                                                        <td class="pc-w620-spacing-5-10-5-10" valign="top" style="padding: 10px 10px 10px 10px;">
                                                                                                                            <table width="30%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="margin: auto;">
                                                                                                                                <tr>
                                                                                                                                    <!--[if gte mso 9]>
                                                                                                                ...
                                                                                                                <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                                                                                    <tr>
                                                                                                                        <td class="pc-w620-spacing-10-20-20-20" align="center" valign="top" style="padding: 20px 20px 20px 20px;">
                                                                                                                            <img src="D:\Development\laravel\PMGI\public\image/email/tekun-banner.jpg" class="" width="504" height="auto" alt="TEKUN Banner" style="display: block; outline: 0; line-height: 100%; -ms-interpolation-mode: bicubic; width:100%; height: auto; border-radius: 21px 21px 21px 21px; border: 0;" />
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                                                                </table>
                                                                                                            </td>
