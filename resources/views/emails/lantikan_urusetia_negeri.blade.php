...
<head>
    ...
    <!-- Using system fonts instead of Google Fonts for better wkhtmltoimage compatibility -->
    ...
    <style>
        @media all {
            /* Using system fonts instead of Google Fonts for wkhtmltoimage compatibility */
        }
    </style>
    <!--<![endif]-->
    <!--[if mso]>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                            <tr>
                                                <td class="pc-w620-spacing-0-0-0-0" style="padding: 0px 0px 0px 0px;">
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                                        <tr>
                                                            <td valign="top" class="pc-w620-padding-30-0-24-0" style="padding: 40px 0px 40px 0px; border-radius: 20px 20px 0px 0px; background-color: #e8faf3;" bgcolor="#e8faf3">
                                                                                ...
                                                                                <tr>
                                                                                    <td valign="top" align="center" style="padding: 0px 10px 0px 10px;">
                                                                                        <div class="pc-font-alt pc-w620-fontSize-26px" style="line-height: 100%; letter-spacing: -0.04em; font-family: Arial, Helvetica, sans-serif; font-size: 30px; font-weight: bold; font-variant-ligatures: normal; color: #26392a; text-align: center; text-align-last: center;">
                                                                                            <div><span>Anda telah dilantik sebagai </span>
                                                                                            </div>
                                                                                            <div><span>Urusetia Negeri {{ $state }} </span>
                                                                                            </div>
                                                                                            <div><span>bagi sesi PMGi</span>
                                                                                            </div>
                                                                                            <div><span>﻿</span>
                                                                                            </div>
                                                                                        </div>
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                                        <tr>
                                                            <td valign="top" class="pc-w620-padding-28-24-28-24" style="padding: 40px 40px 20px 40px; border-radius: 0px; background-color: #ffffff;" bgcolor="#ffffff">
                                                                <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                                    <tr>
                                                                        <td class="pc-w620-spacing-0-0-28-0" align="center" valign="top" style="padding: 0px 0px 39px 0px;">
                                                                                ...
                                                                                <tr>
                                                                                    <td valign="top" align="left">
                                                                                        <div class="pc-font-alt pc-w620-fontSize-15px" style="line-height: 21px; letter-spacing: -0.2px; font-family: Arial, Helvetica, sans-serif; font-size: 18px; font-weight: normal; font-variant-ligatures: normal; color: #333333; text-align: left; text-align-last: left;">
                                                                                            <div><span>Dengan segala hormatnya, saya merujuk kepada perkara di atas.</span>
                                                                                            </div>
                                                                                            <div><span><br />4.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sukacita dimaklumkan bahawa Tuan/Puan dipilih dan dipertanggungjawabkan untuk mengurus pelaksanaan sesi PMGi diperingkat negeri {{ $state }}.</span>
                                                                                            </div>
                                                                                            <div><span> <br />5.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sehubungan itu, Tuan/puan diminta mengemaskini maklumat lantikan PYM yang akan diselaraskan oleh Pengurus Negeri. Tuan/puan juga dikehendaki memaklumkan kepada PYM bagi pelaksanaan sesi PMGi tertakluk kepada tarikh, masa dan tempat yang akan ditetapkan.</span>
                                                                                            <div><span> <br />6.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tuan/puan juga dikehendaki memantau dan membuat semakan dan maklumat serta dokumen penilaian yang telah dilengkapkan dengan sempurna.</span>
                                                                                            </div>
                                                                                            <div><span> <br />Sekian, terima kasih atas kesediaan dan komitmen Tuan/Puan dalam menjalankan tanggungjawab ini.</span>
                                                                                            </div>
                                                                                            <div><span><br />Yang benar,</span>
                                                                                            </div>
                                                                                            <div style="font-weight: bold;"><span><br />Jabatan Pemantauan dan Operasi Cawangan</span>
                                                                                            </div>
                                                                                            <div><span> </span>
                                                                                            </div>
                                                                                        </div>
