                                                                                ...
                                                                                <tr>
                                                                                    <td valign="top" align="center" style="padding: 0px 10px 0px 10px;">
                                                                                        <div class="pc-font-alt pc-w620-fontSize-26px" style="line-height: 100%; letter-spacing: -0.04em; font-family: 'Fraunces', Arial, Helvetica, sans-serif; font-size: 30px; font-weight: bold; font-variant-ligatures: normal; color: #26392a; text-align: center; text-align-last: center;">
                                                                                            <div><span>Permohonan Pelaksanaan Tindakan</span>
                                                                                            </div>
                                                                                ...
                                                                                <tr>
                                                                                    <td valign="top" align="left">
                                                                                        <div class="pc-font-alt pc-w620-fontSize-15px" style="line-height: 21px; letter-spacing: -0.2px; font-family: 'Rubik', Arial, Helvetica, sans-serif; font-size: 18px; font-weight: normal; font-variant-ligatures: normal; color: #333333; text-align: left; text-align-last: left;">
                                                                                            <div><span>Saya seperti yang di arahkan,</span>
                                                                                            </div>
                                                                                            <div><span><br />Berdasarkan keputusan sesi Jawatankuasa Timbang Tara yang telah diadakan pada tarikh {{ $dateMeeting }} bertempat di {{ $venue }}, hasil daripada penilaian dan tinjauan panel jawatankuasa terhadap prestasi kerja pegawai yang dinilai, kami dengan ini memohon tindakan tatatertib diambil terhadap pegawai tersebut:</span>
                                                                                            </div>
                                                                                            <div><span> <br />Nama Pegawai : {{ $pydName }} ({{ $pydIc }})</span>
                                                                                            <div><span> <br />Negeri : {{ $pydState }}
                                                                                            </div>
                                                                                            <div><span> <br />Cawangan : {{ $pydBranch }}
                                                                                            </div>
                                                                                            <div><span> <br />Dilampirkan bersama maklumat dan dokumen berkaitan prestasi pegawai dan hasil penilaian sesi PMGi dan Timbang Tara yang telah dijalankan untuk rujukan dan tindakan lanjut pihak tuan/puan.</span>
                                                                                            </div>
                                                                                            <div><span> <br />Saya yang menjalankan amanah.</span>
                                                                                            </div>
                                                                                            <div style="font-weight: bold;"><span><br />Ketua Jabatan Pemantauan dan Operasi Cawangan</span>
                                                                                            </div>
                                                                                            <div><span> </span>
                                                                                            </div>
                                                                                        </div>
